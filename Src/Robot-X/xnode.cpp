...
void XNode::slotGenerateCode(QString dir)
{
    ...
    if(!headerinfo.exists())
    {
        ...
        if(file.open(QIODevice::WriteOnly | QIODevice::Text))
        {
            ...
            stream<<QString("")<<"\n";
            stream<<QString("//If you need to refer params type of other node class, please uncomment below and comment its own params type.")<<"\n";
            ...
            stream<<QString("")<<"\n";
            stream<<QString("//If you need to refer vars type of other node class, please uncomment below and comment its own vars type.")<<"\n";
            ...
            stream<<QString("")<<"\n";
            stream<<QString("//If you need to refer data type of other node class, please uncomment below and comment its own data type.")<<"\n";
    ...
    if(!cppinfo.exists())
    {
        ...
        if(file.open(QIODevice::WriteOnly | QIODevice::Text))
        {
            ...
            stream<<QString("")<<"\n";
            stream<<QString("//If you need to use extended node, please uncomment below and comment the using of default node")<<"\n";
            ...
            stream<<QString("")<<"\n";
            stream<<QString("//If you don't need to initialize node, you can delete this code segment")<<"\n";
            stream<<QString("NODE_FUNC_DEF_EXPORT(bool, initializeNode)")<<"\n";
            stream<<QString("{")<<"\n";
            stream<<QString("\tNOUNUSEDWARNING;")<<"\n";
            stream<<QString("\treturn 1;")<<"\n";
            stream<<QString("}")<<"\n";
            stream<<QString("")<<"\n";
            stream<<QString("//If you don't need to manually open node, you can delete this code segment")<<"\n";
            ...
            stream<<QString("}")<<"\n";
            stream<<QString("")<<"\n";
            stream<<QString("//If you don't need to manually close node, you can delete this code segment")<<"\n";
