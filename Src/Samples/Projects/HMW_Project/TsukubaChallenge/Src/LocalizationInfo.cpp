...
NODE_FUNC_DEF_EXPORT(bool, initializeNode)
{
    ...
    vars->layout->addWidget(vars->info);
...
NODE_FUNC_DEF_EXPORT(bool, main)
{
    ...
    vars->info->setText(QString("X=%1\nY=%2\nA=%3").arg(data->posx).arg(data->posy).arg(data->theta));
	return 1;
}
