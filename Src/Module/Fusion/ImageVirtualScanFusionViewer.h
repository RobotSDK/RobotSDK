#ifndef IMAGEVIRTUALSCANFUSIONVIEWER
#define IMAGEVIRTUALSCANFUSIONVIEWER
...
#undef NODE_CLASS
#define NODE_CLASS ImageVirtualScanFusionViewer
...
public:
    ...
    ADD_QWIDGET(QLabel, viewer, "Image & Virtual Scan Fusion Viewer")
};
